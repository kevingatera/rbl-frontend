...
// Get artists
export const getArtists = createAsyncThunk('artists/getAll', async (artist, thunkAPI) => {
  try {
...
export const persistArtistRate = createAsyncThunk('artists/changeRate', async ({ artistId, newRate }, thunkAPI) => {
  try {
...
export const payoutArtist = createAsyncThunk('artists/payout', async (artistId, thunkAPI) => {
  try {
